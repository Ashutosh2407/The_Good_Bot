...
starter_encouragements = ["You are great person / bot","Hang in there, buddy","You got this","Cheer up!!"]

#CREATE A SWITCH FOR A BOT TO RESPOND OR NOT
...
async def on_message(message):
  ...
  if msg.startswith("$inspire"):
    await message.channel.send(get_helper())
